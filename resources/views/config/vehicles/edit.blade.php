...
<div class="container" style="max-width:500px">
    <h1><i class="fas fa-edit me-2" style="color:#cc2200;font-size:1rem"></i>Editar unidad</h1>
    <div style="background:#1e1e1e;border:1px solid #2a2a2a;border-radius:10px;padding:24px;">
        <form action="{{ route('config.vehicles.update', $vehicle->id) }}" method="POST">
            @csrf @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-4">
                <div class="form-check">
                    <input type="checkbox" name="active" id="active" class="form-check-input" {{ $vehicle->active ? 'checked' : '' }}>
