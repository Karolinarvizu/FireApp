...
@section('content')
<div class="container">
    <h1><i class="fas fa-building me-2" style="color:#cc2200;font-size:1rem"></i>Reportes de Instalaciones</h1>
    ...
    <div class="d-flex flex-wrap gap-2 align-items-end mb-3">
        <form action="{{ route('installation_reports.index') }}" method="GET" class="d-flex gap-2 flex-wrap">
            <div>
            ...
            <div class="d-flex gap-1 align-items-end">
                ...
                <a href="{{ route('installation_reports.index') }}" class="btn btn-secondary btn-sm">Limpiar</a>
            </div>
        </form>
        @can('crear reportes')
        <a href="{{ route('installation_reports.create') }}" class="btn btn-primary btn-sm ms-auto">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped has-actions fit-mobile table-report-simple mb-3">
            ...
            <tbody>
                @forelse($installationReports as $installationReport)
                <tr>
                    <td style="color:#666">{{ $installationReport->id }}</td>
    ...
    {{ $installationReports->appends(request()->query())->links() }}
</div>
@endsection
@section('scripts')
<script>
